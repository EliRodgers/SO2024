  ...
  return (
    <header className="relative overflow-hidden">
      ...
      <div className="relative lg:animate-fade mt-[7.2rem] md:mt-[25rem] lg:text-8xl text-[2.2rem] leading-[2.2rem] font-bold font-arial">
        ...
        <div className="relative lg:text-6xl text-base bg-gradient-to-r from-red-800 via-red-800 to-red-600 bg-clip-text text-transparent font-bold italic font-source-sans-pro">
