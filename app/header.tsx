  ...
  return (
    <header className="overflow-hidden">
      ...
      <div className="lg:animate-fade mt-[7.2rem] md:mt-[25rem] lg:text-8xl text-[2.2rem] leading-[2.2rem] font-bold font-arial">
        ...
        <div className="lg:text-2xl text-base bg-gradient-to-r from-lighter-red from-30% via-bright-red to-lighter-red to-70% bg-clip-text text-transparent font-bold italic font-arial">
